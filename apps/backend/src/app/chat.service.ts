...
export class ChatService {
  constructor(
    @InjectRepository(UserEntity1)
    private userEntity: Repository<UserEntity1>,
  ...
  async postDataSignUp(signUpInput: SignUpInput): Promise<UserEntity1> {
    const chatEntity = new UserEntity1();
  ...
  async getAllUsers(): Promise<UserEntity1[]> {
